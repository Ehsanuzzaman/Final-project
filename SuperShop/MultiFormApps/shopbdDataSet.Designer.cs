...
namespace MultiFormApps {
    ...
    public partial class shopbdDataSet : global::System.Data.DataSet {
        ...
        public partial class MEMBERDataTable : global::System.Data.TypedTableBase<MEMBERRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public MEMBERRow AddMEMBERRow(string name, string email, string address, string phone) {
...
namespace MultiFormApps.shopbdDataSetTableAdapters {
    ...
    public partial class MEMBERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[MEMBER] WHERE (([memberid] = @Original_memberid) AND ([name] =" +
                " @Original_name) AND ([email] = @Original_email) AND ([address] = @Original_addr" +
                "ess) AND ([phone] = @Original_phone))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[MEMBER] ([name], [email], [address], [phone]) VALUES (@name, @" +
                "email, @address, @phone);\r\nSELECT memberid, name, email, address, phone FROM MEM" +
                "BER WHERE (memberid = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[MEMBER] SET [name] = @name, [email] = @email, [address] = @address, [phone] = @phone WHERE (([memberid] = @Original_memberid) AND ([name] = @Original_name) AND ([email] = @Original_email) AND ([address] = @Original_address) AND ([phone] = @Original_phone));
SELECT memberid, name, email, address, phone FROM MEMBER WHERE (memberid = @memberid)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MultiFormApps.Properties.Settings.Default.shopbdConnectionString1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT memberid, name, email, address, phone FROM dbo.MEMBER";
        ...
        public virtual int Fill(shopbdDataSet.MEMBERDataTable dataTable) {
        ...
        public virtual shopbdDataSet.MEMBERDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            shopbdDataSet.MEMBERDataTable dataTable = new shopbdDataSet.MEMBERDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(shopbdDataSet.MEMBERDataTable dataTable) {
        ...
        public virtual int Delete(int Original_memberid, string Original_name, string Original_email, string Original_address, string Original_phone) {
        ...
        public virtual int Update(string name, string email, string address, string phone, int Original_memberid, string Original_name, string Original_email, string Original_address, string Original_phone, int memberid) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string email, string address, string phone, int Original_memberid, string Original_name, string Original_email, string Original_address, string Original_phone) {
            return this.Update(name, email, address, phone, Original_memberid, Original_name, Original_email, Original_address, Original_phone, Original_memberid);
        }
    }
